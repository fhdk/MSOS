...
## Table of contents
* [What is astOS?](https://github.com/fhdk/msos#what-is-astos)
* [astOS compared to other similar distributions](https://github.com/fhdk/msos#astos-compared-to-other-similar-distributions)
* [ast and astOS documentation](https://github.com/fhdk/msos#additional-documentation)
...
* [Additional documentation](https://github.com/fhdk/msos#additional-documentation)
  ...
  * [Configuring dual boot](https://github.com/fhdk/msos#dual-boot)
  * [Updating ast itself](https://github.com/fhdk/msos#updating-ast-itself)
  * [Debugging ast](https://github.com/fhdk/msos#debugging-ast)
  * [Setting up the AUR](https://github.com/fhdk/msos#aur-setup)
...
* This update only updates the system packages, in order to update ast itself see [this section](https://github.com/fhdk/msos#updating-ast-itself)
